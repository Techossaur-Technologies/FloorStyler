            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    @if (Session::has('message'))
                       <div class="alert alert-info"><i class="pe-7s-gleam"></i>{{ Session::get('message') }}</div>
                    @endif
                    {{Form::open(array('id'=>'formdata','files'=>true,'action' => 'assignmentController@update_addcomment', 'method'=>'POST', 'enctype'=>"multipart/form-data"))}}
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn w-xs btn-success" name="submit">Add Comment</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#formdata").validate({
          ...
          messages: {
            'images[]': {
              accept: "Only jpg and png suported"
            },
            'comment': {
